...
void SAMAPP_CoPro_Track()
{
	...
	while(LoopFlag--)
	{
		...
		Gpu_CoCmd_Text(phost,(DispWidth - 40), 20, 26, OPT_CENTER, "Vertical track");
...
void SAMAPP_Sound()
{
	...
	while(LoopFlag--)
	{
		...
		Gpu_CoCmd_Slider(phost, DispWidth - 15, 20, 8, (DispHeight - 40), 0, currfreq, 88);
...
#endif
{
    ...
    //App_Common_Start(&host,info); //Disable due to lack of memory
	...
	#ifdef SAMAPP_ENABLE_APIS_SET0_A	
	SAMAPP_GPU_Points();
	SAMAPP_GPU_Lines();
    ...
    #endif
#endif
	#ifdef SAMAPP_ENABLE_APIS_SET0_B
	SAMAPP_GPU_Fonts();
	SAMAPP_GPU_Text8x8();
	SAMAPP_GPU_TextVGA();
	SAMAPP_GPU_Bargraph();
	...
	#ifdef SAMAPP_ENABLE_APIS_SET1_A
	SAMAPP_CoPro_Logo();
	...
	#endif
	#ifdef SAMAPP_ENABLE_APIS_SET1_B
	...
	//#ifdef SAMAPP_ENABLE_APIS_SET2_A
	SAMAPP_CoPro_Inflate();
	//#endif
	//#ifdef SAMAPP_ENABLE_APIS_SET2_B
	 ...
	 */
#if (defined (SAMAPP_ENABLE_APIS_SET9)) && (!defined(FT900_PLATFORM)) &&  (!defined(FT93X_PLATFORM))
#ifdef SAMAPP_ENABLE_APIS_SET9
#if defined(FT81X_ENABLE) && !defined(MSVC_FT800EMU)
	//SAMAPP_API_Reset_Context();
